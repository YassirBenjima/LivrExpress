document.addEventListener("DOMContentLoaded", () => {
  const deleteButtons = Array.from(
    document.querySelectorAll('[data-bon-delete-open="true"]'),
  );
  ...
  if (deleteForm && deleteTitle && deleteToken) {
  ...
  document.querySelectorAll('[data-bon-download="true"]').forEach((link) => {
    link.addEventListener("click", async (event) => {
      ...
      const filename = link.getAttribute("data-filename") || "bon.pdf";
